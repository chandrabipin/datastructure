...
public class OP002StaticSynchronizedBlockExample {
	...
	//'synchronized(ClassName.class)' key word in starting of the block.
	...
	static private void aMethod(int n) {
		synchronized(OP002StaticSynchronizedBlockExample.class) {
			for(int i=0;i<5;i++) {
