...
public class OP002ObjectSynchronizedMethodExample {
	...
	synchronized private void aMethod(int n) {
		for(int i=0;i<5;i++) {
	...
	public static void main(String[] args) {
		...
		OP002ObjectSynchronizedMethodExample o = new OP002ObjectSynchronizedMethodExample();
